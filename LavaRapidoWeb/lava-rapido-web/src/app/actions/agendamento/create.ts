...
export async function creat(prevState: any, formData: FormData){
    ...
    const data = {
        ...
        cadastrousuario: {
            id: formData.get("cadastrousuario")
        },
    ...
    const resp = await fetch(process.env.API_BASE_URL + "/agendamento", options)
